...
using MultiTool.Menu.Options.Settings.Options;
using MultiTool.Menu.Options.Settings.Options.UserSettingsOptions;

namespace MultiTool.Menu.Options.Settings
{
